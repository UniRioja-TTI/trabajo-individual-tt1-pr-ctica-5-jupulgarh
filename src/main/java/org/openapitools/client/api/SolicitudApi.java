...
public class SolicitudApi extends BaseApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public SolicitudResponse solicitudSolicitarPost(String nombreUsuario, Solicitud solicitud) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<SolicitudResponse> solicitudSolicitarPostWithHttpInfo(String nombreUsuario, Solicitud solicitud) throws RestClientException {
        ...
        ParameterizedTypeReference<SolicitudResponse> localReturnType = new ParameterizedTypeReference<SolicitudResponse>() {};
