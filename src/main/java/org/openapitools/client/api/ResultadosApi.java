...
public class ResultadosApi extends BaseApi {
     ...
     */
    public ResultsResponse resultadosPost(String nombreUsuario, Integer tok) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<ResultsResponse> resultadosPostWithHttpInfo(String nombreUsuario, Integer tok) throws RestClientException {
        ...
        ParameterizedTypeReference<ResultsResponse> localReturnType = new ParameterizedTypeReference<ResultsResponse>() {};
